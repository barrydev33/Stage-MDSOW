package fr.mdsow.gestionstock.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.mdsow.gestionstock.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.mdsow.gestionstock.repository.UserRepository.USERS_BY_EMAIL_CACHE);
