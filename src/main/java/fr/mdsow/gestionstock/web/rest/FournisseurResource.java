...
import fr.mdsow.gestionstock.service.FournisseurService;
...
/**
 * REST controller for managing {@link fr.mdsow.gestionstock.domain.Fournisseur}.
 */
@RestController
...
public class FournisseurResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<FournisseurDTO>> getAllFournisseurs(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
