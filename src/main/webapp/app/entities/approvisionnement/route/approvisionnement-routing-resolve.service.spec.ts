...
import approvisionnementResolve from './approvisionnement-routing-resolve.service';

describe('Approvisionnement routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: ApprovisionnementService;
  let resultApprovisionnement: IApprovisionnement | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IApprovisionnement returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        approvisionnementResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultApprovisionnement).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IApprovisionnement>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
