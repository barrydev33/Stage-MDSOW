...
import { sampleWithRequiredData } from '../approvisionnement.test-samples';
...
describe('Approvisionnement Management Component', () => {
  let comp: ApprovisionnementComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ApprovisionnementComponent],
      providers: [
        {
      ...
      .overrideTemplate(ApprovisionnementComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.approvisionnements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to approvisionnementService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getApprovisionnementIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getApprovisionnementIdentifier).toHaveBeenCalledWith(entity);
